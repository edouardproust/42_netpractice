...
var hosts = [
    {'id':'A', 'type':'host', 'name':'Machine A', 'geometry':'160x160+900+800', 'img':'host.png', 'labelpos':'0,200'},
    {'id':'B', 'type':'host', 'name':'Machine B', 'geometry':'160x160+800+200', 'img':'host.png', 'labelpos':'180,30'},
    {'id':'R', 'type':'router', 'name':'The Mighty Router', 'geometry':'160x160+400+500', 'img':'router.png', 'labelpos':'-200,50'}
];
