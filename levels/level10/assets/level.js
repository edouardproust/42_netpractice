...
var hosts = [
    {'id':'H1', 'type':'host', 'name':'Host one', 'geometry':'160x160+900+800', 'img':'host.png', 'labelpos':'0,200'},
    {'id':'H2', 'type':'host', 'name':'Host two', 'geometry':'160x160+800+200', 'img':'host.png', 'labelpos':'180,30'},
    {'id':'H3', 'type':'host', 'name':'Host three', 'geometry':'160x160+600+1200', 'img':'host.png', 'labelpos':'180,100'},
    {'id':'H4', 'type':'host', 'name':'Host four', 'geometry':'160x160+100+1200', 'img':'host.png', 'labelpos':'180,100'},
    {'id':'R1', 'type':'router', 'name':'Router one', 'geometry':'160x160+400+500', 'img':'router.png', 'labelpos':'-150,150'},
    {'id':'R2', 'type':'router', 'name':'Router two', 'geometry':'160x160+400+900', 'img':'router.png', 'labelpos':'-30,170'},
